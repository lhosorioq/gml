...
<?php $__env->startSection('gTitulo'); ?>
    Edit User <?php echo e($user->nombres); ?>
...
unset($__errorArgs, $__bag); ?>
                    <input 
                        ...
                        name="apellidos"
                        type="text"
                        value="<?php echo e(@old('apellidos', $user->apellidos )); ?>"
...
unset($__errorArgs, $__bag); ?>
                    <input 
                        ...
                        name="cedula"
                        type="number"
                        value="<?php echo e(@old('cedula', $user->cedula )); ?>"
                    ...
                    >
                        <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($categoria->id); ?>"
                                <?php if( $user->categoria_id == $categoria->id ): ?>
                                    selected="selected"
                                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>"
                    >
                        <?php $__currentLoopData = $paises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pais): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option
                                <?php if( $user->pais == $pais->name->common ): ?>
                                    selected="selected"
                                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    <input 
                        id="celular"
                        name="celular"
                        value="<?php echo e(@old('celular', $user->celular )); ?>"
                        type="number"
...
<?php echo $__env->make('shared.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Desarrollo\Aplicaciones\gml\gmlsoftware\resources\views/user/edit.blade.php ENDPATH**/ ?>